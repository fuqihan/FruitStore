...
<jsp:include page="homeTop.jsp"></jsp:include>
    ...
    <div id="perDiv" class="reg_main reg_border regTab">
        <ul class="individualUserBg">
            <form action="addUser.html" method="post" name="formUser">
                <li class="regMb30">
                    <label>
                        <font>*</font>
                        账户名：
                    ...
                    <span class="regM defaultBorder">
                        <input name="userName" type="text" class="regInput" id="userName" maxlength="80">
                    </span>
                ...
                <li class="regMb30">
                    ...
                    <span class="regM defaultBorder"><input name="telPhone" type="text" class="regInput" /></span>
                </li>
                <div class="clear"></div>
                <li class="regPl88">
