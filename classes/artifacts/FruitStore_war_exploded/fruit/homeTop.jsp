...
<div class="topMenu">
    <div class="pW">
        <ul class="fr topTh">
            <li id="ECS_MEMBERZONE" class="login">
                ...
                <c:if test="${sessionScope.name!=null}">
                    <li class="dropdown" id="accountmenu">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">${sessionScope.name}<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="manageOrder.html">个人中心</a></li>
                            <li><a href="removeUser.html">退出登录</a></li>
                        </ul>
                    </li>
            ...
            <li class="menus">
                <a class="trackref t" href="sellerLiginView.html" rel="nofollow">商家</a>

            </li>
            <li class="menus">
                <a class="trackref t" target="_self" href="#" rel="nofollow">帮助</a>
