            ...
            <ul class="user-menu">
                <li class="dropdown pull-right">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="/fruit/adminLogin.html"><span class="glyphicon glyphicon-log-out"></span> 退出</a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li><a href="/fruit/adminLogin.html"><span class="glyphicon glyphicon-user" ></span> 退出登录</a></li>
    </ul>
   </div><!--/.sidebar-->
</body>
</body>
